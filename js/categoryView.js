define([
    ...
    './radioOption',
    './radiocons'
], function(Adapt, QuestionView, radioOption, RadioCons) {

    var CategoryView = QuestionView.extend({
        ...
        setUpDropdowns: function() {
            ...
            this.$('.matching-item').each(function(i, el) {
                ...
                dropdown.on('change', self.onOptionSelected);
            });
            this.enableQuestion();
        ...
        onOptionSelected: function(dropdown) {
            // console.log("change fired on set!!!!");
