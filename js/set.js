define([
    ...
    var Set = Backbone.View.extend({
        ...
        getDefaults: function() {
            return {
                load: set.defaults.load,
                openList: set.defaults.openList,
                closeList: set.defaults.closeList,
                scrollToItem: set.defaults.scrollToItem
            };
        },
        ...
        setUpItems: function() {
            ...
            $options.each(function(index, el) {
                ...
                console.log("OPTION PUSHED", option, "wtf");
        ...
        toggleDisabled: function(value) {
            console.log("toggledisabled", vlaue);
            // if (value === undefined) {
